...
fn unit_renamed() {
    ...
    impl Debug for Outer {
        fn fmt(&self, f: &mut Formatter<'_>) -> Result<(), fmt::Error> {
            debug_helper::impl_debug_for_enum!({A::F0, (F1(..)), {F2{..}}}, f, self);
        }
    }
...
fn one_field_nested() {
    ...
    assert_eq!(
        "Outer::F1(Inner { f1: 0000000005, f2: 0000000010 })",
    ...
    assert_eq!(
        "Outer::F2 { f2: Inner { f1: 0000000005, f2: 0000000010 } }",
...
fn all() {
    ...
    assert_eq!(
        "Outer::F1(0000001.23, Inner { f1: 0000000005, f2: 0000000010 })",
        format!("{:010.2?}", outer_2)
    );
    assert_eq!(
        "Outer::F1(0000001.23, Inner { f1: 0000000005, f2: 0000000010 })",
...
fn all_renamed() {
    ...
    impl Debug for Outer {
        fn fmt(&self, f: &mut Formatter<'_>) -> Result<(), fmt::Error> {
            debug_helper::impl_debug_for_enum!({A::F0, (F1(f1, f2): (.f1, .f2)), {F2{f1, f2}: (.f1, .f2)}}, f, self);
        }
    }
    ...
    assert_eq!(
        "A::F1(0000001.23, Inner { f1: 0000000005, f2: 0000000010 })",
        format!("{:010.2?}", outer_2)
    );
    assert_eq!(
        "A::F1(0000001.23, Inner { f1: 0000000005, f2: 0000000010 })",
    ...
    assert_eq!(
        "A::F2 { f1: 0000001.23, f2: Inner { f1: 0000000005, f2: 0000000010 } }",
        format!("{:010.2?}", outer_3)
    );
    assert_eq!(
        "A::F2 { f1: 0000001.23, f2: Inner { f1: 0000000005, f2: 0000000010 } }",
...
fn custom_fmt() {
    ...
    assert_eq!(
        "Outer::F1(number, Inner { f1: 0000000005, f2: 0000000010 })",
        format!("{:010.2?}", outer_2)
    );
    assert_eq!(
        "Outer::F1(number, Inner { f1: 0000000005, f2: 0000000010 })",
    ...
    assert_eq!(
        "Outer::F1(number, Inner { f1: ????5?????, f2: ????10???? })",
        format!("{:?^10.2?}", outer_2)
    );
    assert_eq!(
        "Outer::F1(number, Inner { f1: 5#########, f2: 10######## })",
    ...
    assert_eq!(
        "Outer::F2 { f1: number, f2: Inner { f1: 0000000005, f2: 0000000010 } }",
        format!("{:010.2?}", outer_3)
    );
    assert_eq!(
        "Outer::F2 { f1: number, f2: Inner { f1: 0000000005, f2: 0000000010 } }",
...
fn reset() {
    ...
    assert_eq!(
        "Outer::F1(Inner { f1: 0000000005, f2: 0000000010 }, 0000001.23)",
        format!("{:010.2?}", outer_2)
    );
    assert_eq!(
        "Outer::F1(Inner { f1: 0000000005, f2: 0000000010 }, 0000001.23)",
    ...
    assert_eq!(
        "Outer::F2 { f1: Inner { f1: ????5?????, f2: ????10???? }, f2: ???1.23??? }",
        format!("{:?^10.2?}", outer_3)
    );
    assert_eq!(
        "Outer::F2 { f1: Inner { f1: 5#########, f2: 10######## }, f2: 1.23###### }",
